...
int main() {
	...
	Shader object_shader("C:\\Users\\Grant\\LearnOpenGL Files\\Lighting\\model_loading.vs", "C:\\Users\\Grant\\LearnOpenGL Files\\Lighting\\model_loading.fs");
	Shader depth_shader("C:\\Users\\Grant\\LearnOpenGL FIles\\Lighting\\depth_map.vs", "C:\\Users\\Grant\\LearnOpenGL Files\\Lighting\\depth_map.fs");
	Shader quad_shader("C:\\Users\\Grant\\LearnOpenGL Files\\Lighting\\quad.vs", "C:\\Users\\Grant\\LearnOpenGL Files\\Lighting\\quad.fs");
	Shader lamp_shader("C:\\Users\\Grant\\LearnOpenGL FIles\\Lighting\\lamp.vs", "C:\\Users\\Grant\\LearnOpenGL FIles\\Lighting\\lamp.fs");
	Shader cube_shader("C:\\Users\\Grant\\LearnOpenGL FIles\\Lighting\\cube.vs", "C:\\Users\\Grant\\LearnOpenGL FIles\\Lighting\\cube.fs");

	Model nanosuit("C:/Users/Grant/LearnOpenGL Files/Assimp/nanosuit/nanosuit.obj");

	Texture wall(GL_TEXTURE_2D, Texture::DIFFUSE);
	wall.bind();
	wall.generate_texture("C:\\Users\\Grant\\LearnOpenGL FIles\\Lighting\\wall.jpg", GL_RGB);
	...
	*/
	...
	// use GL_CLAMP_TO_BORDER instead of GL_REPEAT so that there are the depth texture is not repeated over the scene
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_BORDER);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_BORDER);
	// prevent the areas not in the depth map from being black
	...
	*/
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glm::mat4 light_proj = glm::ortho(-10.0f, 10.0f, -10.0f, 10.0f, light_near_plane, light_far_plane);
		...
		glUniformMatrix4fv(glGetUniformLocation(depth_shader.ID, "lightSpaceMatrix"), 1, GL_FALSE, glm::value_ptr(light_space_matrix));
		...
		glUniformMatrix4fv(glGetUniformLocation(object_shader.ID, "lightSpaceMatrix"), 1, GL_FALSE, glm::value_ptr(light_space_matrix));
