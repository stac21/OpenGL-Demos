...
int main() {
	...
	Shader plane_shader("C:\\Users\\Grant\\LearnOpenGL Files\\Parallax Mapping\\plane.vs", "C:\\Users\\Grant\\LearnOpenGL Files\\Parallax Mapping\\plane.fs");
	Shader quad_shader("C:\\Users\\Grant\\LearnOpenGL Files\\Parallax Mapping\\quad.vs", "C:\\Users\\Grant\\LearnOpenGL Files\\Parallax Mapping\\quad.fs");
	Shader lamp_shader("C:\\Users\\Grant\\LearnOpenGL FIles\\Parallax Mapping\\lamp.vs", "C:\\Users\\Grant\\LearnOpenGL FIles\\Parallax Mapping\\lamp.fs");

	Texture brick_wall(GL_TEXTURE_2D, Texture::DIFFUSE);
	brick_wall.bind();
	brick_wall.generate_texture("C:\\Users\\Grant\\LearnOpenGL Files\\Parallax Mapping\\bricks2.jpg", GL_RGB);
	
	Texture brick_wall_normal(GL_TEXTURE_2D, Texture::NORMAL);
	brick_wall_normal.bind();
	brick_wall_normal.generate_texture("C:\\Users\\Grant\\LearnOpenGL Files\\Parallax Mapping\\bricks2_normal.jpg", GL_RGB);

	// use the inverse of the heihtmap because it is easier to fake depth than to fake height on flat surfaces
	Texture brick_wall_disp(GL_TEXTURE_2D, Texture::HEIGHT);
	brick_wall_disp.bind();
	brick_wall_disp.generate_texture("C:\\Users\\Grant\\LearnOpenGL Files\\Parallax Mapping\\bricks2_disp.jpg", GL_RGB);

	Texture toy_box(GL_TEXTURE_2D, Texture::DIFFUSE);
	toy_box.bind();
	toy_box.generate_texture("C:\\Users\\Grant\\LearnOpenGL Files\\Parallax Mapping\\wood.png", GL_RGB);
	Texture toy_box_normal(GL_TEXTURE_2D, Texture::NORMAL);
	toy_box_normal.bind();
	toy_box_normal.generate_texture("C:\\Users\\Grant\\LearnOpenGL Files\\Parallax Mapping\\toy_box_normal.png", GL_RGB);
	Texture toy_box_disp(GL_TEXTURE_2D, Texture::HEIGHT);
	toy_box_disp.bind();
	toy_box_disp.generate_texture("C:\\Users\\Grant\\LearnOpenGL Files\\Parallax Mapping\\toy_box_disp.png", GL_RGB);

	plane_shader.use();
	plane_shader.set_int("texture_diffuse1", 0);
	plane_shader.set_int("texture_normal1", 1);
	plane_shader.set_int("texture_disp1", 2);
	quad_shader.use();
	...
	*/
	...
	while (!glfwWindowShouldClose(window)) {
		...
		plane_shader.set_float("heightScale", height_scale);
