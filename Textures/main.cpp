...
int main() {
	...
	Shader shader("C:\\Users\\Grant\\LearnOpenGL Files\\Textures\\vertexShader.txt", "C:\\Users\\Grant\\LearnOpenGL Files\\Textures\\fragmentShader.txt");

	// load the image of the container and assign the widht, height, and num_channels to those of the image
	int width, height, num_channels;
	unsigned char* data1 = stbi_load("C:\\Users\\Grant\\LearnOpenGL Files\\Textures\\container.jpg", &width, &height, &num_channels, 0);
	...
	unsigned char* data2 = stbi_load("C:\\Users\\Grant\\LearnOpenGL Files\\Textures\\awesomeface.png", &width, &height, &num_channels, 0);
